...
Argument 1 - N/a
#### Desc.
Jump to the location stored in the register supplied if the zero flag is true.

### JNE
Argument 0 - reg16
Argument 1 - N/a
#### Desc.
Jump to the location stored in the register supplied if the zero flag is false.
